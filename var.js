...
// import {}from './test'; // this used for particular 
// import * as mathops from './test';
// console.log('start');
// setTimeout(
//     function() {
//         console.log('timeout')
...
//     userAge:21
// };
// const{userName}=user; // it is extracting the particular data to be display
// const{userAge}=user;
...
// PROMISE : 
$.ajax({ 
    success:function(){ // callback syntax
    },
    fail:function(){
})
